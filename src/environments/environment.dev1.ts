export const environment = {
  ...
  // This is a global handler and any other tokens required, the endpoint
  // should be added here and the token will be fetched automatically!
  RESOURCES: [
  ...
  adalConfig: {
    ...
    postLogoutRedirectUri:
      'https://coreframeworkdev1.worldbank.org/adalRedirect.html',
    endpoints: {
      graphApiUri: 'https://graph.microsoft.com'
    },
    cacheLocation: 'localStorage',
    redirectUri: 'https://coreframeworkdev1.worldbank.org/adalRedirect.html'
  },
